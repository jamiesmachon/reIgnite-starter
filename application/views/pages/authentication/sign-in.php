		...
		<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
			...
			<div class="d-flex flex-center flex-column flex-lg-row-fluid">
				...
				<div class="w-lg-500px p-10">
					<!--begin::Form-->
					<?php echo form_open( $form_action, [ 'class' => "form w-100", 'novalidate' => "novalidate", 'id' => "kt_sign_in_form", 'data-kt-redirect-url' => $form_redirect ] ); ?>
					<!--begin::Heading-->
					<div class="text-center mb-11">
						<!--begin::Title-->
						<h1 class="text-dark fw-bolder mb-3"><?php echo __( 'Sign In', 'suppliers-portal' ); ?></h1>
						<!--end::Title-->
						<!--begin::Subtitle-->
						<div
					...
					<div class="fv-row mb-8">
						...
						<?php echo form_input( [
							...
							'placeholder'  => __( 'Username or Email Address', 'suppliers-portal' ),
							'autocomplete' => 'off',
					...
					<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
						<div></div>
						<!--begin::Link-->
						<a href="<?php echo base_url( 'reset-password' ); ?>"
						   class="link-primary"><?php echo __( 'Forgot Password?', 'suppliers-portal' ); ?></a>
						<!--end::Link-->
					</div>
					<!--end::Wrapper-->
					<!--begin::Submit button-->
					<div class="d-grid mb-10">
						<button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
							...
							<span class="indicator-label"><?php echo __( 'Sign In', 'suppliers-portal' ); ?></span>
							<!--end::Indicator label-->
					...
					<div class="text-gray-500 text-center fw-semibold fs-6">
						<?php echo __( 'Not a Member yet?', 'suppliers-portal' ); ?>
						<a href="<?php echo base_url( 'sign-up' ); ?>" class="link-primary">
							<?php echo __( 'Sign Up', 'suppliers-portal' ); ?>
						</a>
					</div>
					<!--end::Sign up-->
					<?php echo form_close(); ?>
