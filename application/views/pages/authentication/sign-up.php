		...
		<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
			...
			<div class="d-flex flex-center flex-column flex-lg-row-fluid">
				...
				<div class="w-lg-500px p-10">
					<!--begin::Form-->
					<?php echo form_open( $form_action, [ 'class' => 'form w-100', 'novalidate' => 'novalidate', 'id' => 'kt_sign_up_form', 'data-kt-redirect-url' => $form_redirect ] ); ?>
					<!--begin::Heading-->
					<div class="text-center mb-11">
						<!--begin::Title-->
						<h1 class="text-dark fw-bolder mb-3"><?php echo __( 'Sign Up', 'suppliers-portal' ); ?></h1>
						<!--end::Title-->
						<!--begin::Subtitle-->
						<div
							class="text-gray-500 fw-semibold fs-6"><?php echo __( 'Your Online Supplier Portal', 'suppliers-portal' ); ?></div>
						<!--end::Subtitle=-->
					</div>
					<!--end::Heading-->
					<!--begin::Input group=-->
					<div class="fv-row mb-8">
						...
						<?php echo form_input( [
							'name'         => 'user_login',
							'id'           => 'user_login',
							'class'        => 'form-control bg-transparent' . ( form_error( 'user_login' ) ? ' is-invalid' : '' ),
							'placeholder'  => __( 'Username', 'suppliers-portal' ),
							'autocomplete' => 'off',
					...
					<div class="d-grid mb-10">
						<button type="submit" id="kt_sign_up_submit" class="btn btn-primary">
							...
							<span class="indicator-label"><?php echo __( 'Sign Up', 'suppliers-portal' ); ?></span>
							<!--end::Indicator label-->
					...
					<!--begin::Sign up-->
					<div
						class="text-gray-500 text-center fw-semibold fs-6"><?php echo __( 'Already have an Account ?', 'suppliers-portal' ); ?>
						<a href="<?php echo base_url( 'sign-in' ); ?>"
						   class="link-primary fw-semibold"><?php echo __( 'Sign In', 'suppliers-portal' ); ?></a>
					</div>
					<!--end::Sign up-->
					<?php echo form_close(); ?>
					<!--end::Form-->
