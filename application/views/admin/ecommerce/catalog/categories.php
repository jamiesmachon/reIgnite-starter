		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar">
					<!--begin::Add customer-->
					<a href="/admin/ecommerce/catalog/add-category" class="btn btn-primary">Add Category</a>
					<!--end::Add customer-->
				</div>
				<!--end::Card toolbar-->
			</div>
				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
					...
					<tr>
						...
						<td>
							<div class="d-flex">
								<!--begin::Thumbnail-->
								<a href="/admin/ecommerce/catalog/edit-category" class="symbol symbol-50px">
								...
								<div class="ms-5">
									<!--begin::Title-->
									<a href="/admin/ecommerce/catalog/edit-category"
						...
						<td class="text-end">
							...
							<div
								...
								<div class="menu-item px-3">
									<a href="/admin/ecommerce/catalog/edit-category" class="menu-link px-3">Edit</a>
								</div>
								<!--end::Menu item-->
								<!--begin::Menu item-->
								<div class="menu-item px-3">
						...
						<td>
							<div class="d-flex">
								...
								<div class="ms-5">
									...
									<!--end::Title-->
									<!--begin::Description-->
									<div class="text-muted fs-7 fw-bold">Whatever your activity needs are, we’ve got you
										covered.
									</div>
									<!--end::Description-->
								</div>
