					...
					<div class="card-body pt-15">
						...
						<div class="d-flex flex-center flex-column mb-5">
							...
							<div class="symbol symbol-150px symbol-circle mb-7">
								<img src="/content/media/avatars/300-1.jpg" alt="image"/>
							</div>
							<!--end::Avatar-->
							<!--begin::Name-->
							...
							<div class="card-body pt-0 pb-5">
								...
								<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15381</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#14919</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15755</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15258</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15198</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15535</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#15899</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<tr>
										...
										<td>
											<a href="/admin/ecommerce/sales/details"
											   class="text-gray-600 text-hover-primary mb-1">#14412</a>
										</td>
										<!--end::order=-->
										<!--begin::Status=-->
										<td>
									...
									<div class="mb-7">
										...
										<div class="mt-1">
											...
											<style>.image-input-placeholder {
													background-image: url('/content/media/svg/files/blank-image.svg');
												}

												[data-theme="dark"] .image-input-placeholder {
													background-image: url('/content/media/svg/files/blank-image-dark.svg');
												}</style>
											...
											<div class="image-input image-input-outline image-input-placeholder"
												...
												<div class="image-input-wrapper w-125px h-125px"
												     style="background-image: url('/content/media/avatars/300-1.jpg')"></div>
								...
								<div class="py-0" data-kt-customer-payment-method="row">
									...
									<div class="py-3 d-flex flex-stack flex-wrap">
										...
										<div class="d-flex align-items-center collapsible rotate"
											...
											<!--end::Arrow-->
											<!--begin::Logo-->
											<img src="/content/media/svg/card-logos/mastercard.svg"
											...
											<div class="flex-equal me-5">
												<table class="table table-flush fw-semibold gy-1">
													...
													<tr>
														...
														<td class="text-gray-800">**** 2361</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td class="text-gray-800">Australia
															<div class="symbol symbol-20px symbol-circle ms-2">
																<img
																	src="/content/media/flags/australia.svg"/>
															</div>
														</td>
													</tr>
													<tr>
										...
										<div class="d-flex flex-wrap py-5">
											...
											<div class="flex-equal me-5">
												<table class="table table-flush fw-semibold gy-1">
													...
													<tr>
														<td class="text-muted min-w-125px w-125px">Number</td>
														<td class="text-gray-800">**** 1860</td>
													</tr>
													<tr>
														<td class="text-muted min-w-125px w-125px">Expires</td>
												...
												<table class="table table-flush fw-semibold gy-1">
													...
													<tr>
														...
														<td class="text-gray-800">United Kingdom
															<div class="symbol symbol-20px symbol-circle ms-2">
																<img
																	src="/content/media/flags/united-kingdom.svg"/>
															</div>
														</td>
													</tr>
													<tr>
								...
								<div class="py-0" data-kt-customer-payment-method="row">
									...
									<div class="py-3 d-flex flex-stack flex-wrap">
										...
										<div class="d-flex align-items-center collapsible collapsed rotate"
											...
											<!--begin::Logo-->
											<img
												src="/content/media/svg/card-logos/american-express.svg"
												class="w-40px me-3" alt=""/>
											<!--end::Logo-->
											<!--begin::Summary-->
											<div class="me-3">
										...
										<div class="d-flex flex-wrap py-5">
											...
											<div class="flex-equal me-5">
												<table class="table table-flush fw-semibold gy-1">
													...
													<tr>
														<td class="text-muted min-w-125px w-125px">Number</td>
														<td class="text-gray-800">**** 3567</td>
													</tr>
													<tr>
														<td class="text-muted min-w-125px w-125px">Expires</td>
												...
												<table class="table table-flush fw-semibold gy-1">
													...
													<tr>
														...
														<td class="text-gray-800">United States of America
															<div class="symbol symbol-20px symbol-circle ms-2">
																<img
																	src="/content/media/flags/united-states.svg"/>
															</div>
														</td>
													</tr>
													<tr>
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					...
					<form class="form" action="#" id="kt_modal_add_address_form">
						...
						<div class="modal-footer flex-center">
							<!--begin::Button-->
							<button type="reset" id="kt_modal_add_address_cancel" class="btn btn-light me-3">Discard
							</button>
							<!--end::Button-->
							<!--begin::Button-->
					...
					<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
						...
						<div class="fw-bold d-flex flex-column justify-content-center mb-5">
							...
							<div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
								<img src="/content/media/misc/qr.png" alt="Scan this QR code"/>
							</div>
							<!--end::QR code-->
							<!--begin::Text code-->
