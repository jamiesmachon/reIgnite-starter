			...
			<div class="card-body pt-0">
				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Emma
								Smith</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
						...
						<td class="text-end">
							...
							<div
								...
								<div class="menu-item px-3">
									<a href="/admin/customers/view" class="menu-link px-3">View</a>
								</div>
								<!--end::Menu item-->
								<!--begin::Menu item-->
								<div class="menu-item px-3">
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Melody
								Macy</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Max
								Smith</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Sean
								Bean</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Brian
								Cox</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Mikaela
								Collins</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Francis
								Mitcham</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Olivia
								Wild</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Neil
								Owen</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Dan
								Wilson</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Ana
								Crown</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Robert
								Doe</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">John
								Miller</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
					...
					<tr>
						...
						<!--begin::Name=-->
						<td>
							<a href="/admin/customers/details" class="text-gray-800 text-hover-primary mb-1">Lucy
								Kunic</a>
						</td>
						<!--end::Name=-->
						<!--begin::Email=-->
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					...
					<form class="form" action="#" id="kt_modal_add_customer_form"
					      data-kt-redirect="../../demo1/dist/apps/customers/list">
						<!--begin::Modal header-->
