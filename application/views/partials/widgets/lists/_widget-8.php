	...
	<div class="card-body pt-0">
		...
		<div class="m-0">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/united-states.svg" class="me-4 w-25px"
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/brazil.svg" class="me-4 w-25px"
				     style="border-radius: 4px" alt=""/>
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/turkey.svg" class="me-4 w-25px"
				     style="border-radius: 4px" alt=""/>
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/france.svg" class="me-4 w-25px"
				     style="border-radius: 4px" alt=""/>
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/india.svg" class="me-4 w-25px"
				     style="border-radius: 4px" alt=""/>
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="/content/media/flags/sweden.svg" class="me-4 w-25px"
				     style="border-radius: 4px" alt=""/>
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
