		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
				...
				<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2"
					...
					<!--begin::Wrapper-->
					<div class="py-5">
						<?php $this->load->partial( 'modals/users-search/partials/_suggestions' ); ?>
						<?php $this->load->partial( 'modals/users-search/partials/_results' ); ?>
						<?php $this->load->partial( 'modals/users-search/partials/_empty' ); ?>
					</div>
					<!--end::Wrapper-->
				</div>
				<!--end::Search-->
