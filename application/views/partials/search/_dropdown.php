...
<div id="kt_header_search" class="header-search d-flex align-items-stretch" data-kt-search-keypress="true"
	...
	<div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
		...
		<div data-kt-search-element="wrapper">
			<?php $this->load->partial( 'search/partials/_form-dropdown' ); ?>
			<?php $this->load->partial( 'search/partials/_results' ); ?>
			<?php $this->load->partial( 'search/partials/_main' ); ?>
			<?php $this->load->partial( 'search/partials/_empty' ); ?>
		</div>
		<!--end::Wrapper-->
		<?php $this->load->partial( 'search/partials/_advanced-options' ); ?>
		<?php $this->load->partial( 'search/partials/_preferences' ); ?>
	</div>
	<!--end::Menu-->
</div>
<!--end::Search-->