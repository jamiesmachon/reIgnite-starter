...
$browsers = [ 'OPR'             => 'Opera', 'Flock' => 'Flock', 'Edge' => 'Edge', 'Chrome' => 'Chrome', // Opera 10+ always reports Opera/9.80 and appends Version/<real version> to the user agent string
...
$mobiles = [ // legacy array, old values commented out
