...
$config[ 'live_url' ] = ''; // SEE ENVIROMENT CONFIG FILES
$config[ 'dev_url' ] = ''; // SEE ENVIROMENT CONFIG FILES
...
|--------------------------------------------------------------------------
|
| This item allows you to set namespace to models.
|
...
|
*/
function ci__autoloader( $class )
{
	$class_path = APPPATH . 'core' . DIRECTORY_SEPARATOR . 'abstracts' . DIRECTORY_SEPARATOR . $class . '.php';
	if ( ! class_exists( $class, FALSE ) && file_exists( $class_path ) )
	{
		@include( $class_path );
	}
	
	$class_path = APPPATH . 'core' . DIRECTORY_SEPARATOR . 'interfaces' . DIRECTORY_SEPARATOR . $class . '.php';
	if ( ! class_exists( $class, FALSE ) && file_exists( $class_path ) )
	{
		@include( $class_path );
	}
	
	$class_path = APPPATH . 'core' . DIRECTORY_SEPARATOR . 'data-stores' . DIRECTORY_SEPARATOR . $class . '.php';
	if ( ! class_exists( $class, FALSE ) && file_exists( $class_path ) )
	{
		@include( $class_path );
	}
	
	$class_path = APPPATH . 'core' . DIRECTORY_SEPARATOR . $class . '.php';
	if ( ! class_exists( $class, FALSE ) && file_exists( $class_path ) )
	{
		@include( $class_path );
	}
...
spl_autoload_register( 'ci__autoloader' );
