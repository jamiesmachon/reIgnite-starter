 ...
 * extension is not enabled and that thanks Launchpad's php-gettext library added
 * add-in (BASEPATH/vendor/php-gettext).
 *
 * @package    CodeIgniter
 * @category    Libraries
 * @author    Kader Bouyakoub <bkader@mail.com>
 * @link    https://github.com/bkader/ci-gettext
 */
class CI_Gettext {
	/**
	...
	protected function initialize( array $config = [] )
	{
		...
		{
			$config[ 'gettext_languages' ] = [ 'english' ];
		}
